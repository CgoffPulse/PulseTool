...
export function LeadCard({ lead }: { lead: LeadWithMeta }) {
  ...
  return (
    <Link
      ...
      className="group block rounded-md border border-cream-dk/60 bg-white p-3 shadow-sm transition-all duration-fast hover:-translate-y-0.5 hover:border-amber-mid/60 hover:shadow-card"
    >
