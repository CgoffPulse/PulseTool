...
import { TodayRail } from '@/components/social/today-rail';
import {
  POST_PIPELINE,
  POST_STATUS_LABEL,
  PULSE_HOUSE_SLUG,
...
import {
  ...
  normalizeLocation,
  rideAlongCandidates,
} from '@/lib/social/field-plan';
import { fmtDate, fmtMonth, monthSlug } from '@/lib/social/utils';
        ...
        <div className="grid grid-cols-1 items-end gap-10 lg:grid-cols-[1.5fr,1fr]">
          <div>
            <div className="eyebrow cream">
              Content Workbench · Issue {format(new Date(), 'yyyy.MM')}
            </div>
