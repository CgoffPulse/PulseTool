...
import { ArrowRight, Check, ChevronLeft, FolderGit2, GitBranch } from 'lucide-react';
import { bulkCreateProjects } from '@/lib/dev/actions';
...
/**
 * /dev/projects/discover — walks DEV_PROJECTS_ROOT one level deep, surfaces
 * every git repository, and lets you bulk-import them as
 * `command.projects` rows (kind='internal_build').
 *
 * Engineering-only flow. Other project kinds (client_campaign, etc.) are
 * created manually through Pulse Command.
 */
...
function MissingEnvPanel() {
  return (
    <section className="grain rounded-2xl border border-cream-dk bg-cream-lt p-10 text-center">
      ...
      <p className="mx-auto mt-3 max-w-md font-body text-sm text-green-deep/80">
