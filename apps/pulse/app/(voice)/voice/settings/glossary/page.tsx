import { listClients, listGlossary } from '@/lib/voice/queries';
import {
  archiveGlossaryEntry,
  createGlossaryEntry,
} from '@/lib/voice/actions';
import { GLOSSARY_KINDS } from '@/lib/voice/types';
  ...
  return (
    <div className="flex flex-col gap-8">
      ...
      <div className="flex flex-wrap gap-2">
        <FilterLink href="/voice/settings/glossary" active={filter === ''}>
          All
        </FilterLink>
        <FilterLink
          href="/voice/settings/glossary?client=global"
        ...
        {clients.map(c => (
          <FilterLink
            key={c.id}
            href={`/voice/settings/glossary?client=${c.id}`}
            active={filter === c.id}
          >
            {c.name}
          </FilterLink>
