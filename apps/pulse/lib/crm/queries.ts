...
const LEAD_WITH_META_SELECT = `
  select
    ...
    l.owner_person_id, l.client_id,
    l.industry, l.business_type, l.city, l.region,
    l.website_url, l.instagram_handle, l.facebook_url, l.google_business_url,
    l.decision_maker_name, l.decision_maker_title,
    coalesce(l.services_interested, '{}'::text[]) as services_interested,
    l.budget_signal, l.timeline, l.heat::text as heat,
    l.pain_points, l.current_solution, l.goals, l.referrer,
